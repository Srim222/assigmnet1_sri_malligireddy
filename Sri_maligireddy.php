...
$email = "Maligireds1@nku.edu";
$phone = "+1(859)866-3343";
$summary = "Aspiring software engineer with strong interest in web development.";
...
<html lang="en"> 
<head>
    <title><?php echo $firstName . ' ' . $lastName; ?>'s Resume</title>
    
    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="<?php echo $firstName . ' ' . $lastName; ?>'s resume">
...
<body>
				    ...
				    <div class="col">
					    <div class="row p-4 justify-content-center justify-content-md-between">
						    <div class="primary-info col-auto">
							    <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase"><?php echo $firstName . ' ' . $lastName; ?></h1>
							    <div class="title mb-3">Full stack devolper</div>
    ...
    <footer class="footer text-center pt-2 pb-5">
        ...
        <small class="copyright">Designed with <span class="sr-only">love</span><i class="fas fa-heart"></i> by <?php echo $firstName . ' ' . $lastName; ?></small>
    </footer>
